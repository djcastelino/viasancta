...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#f5f5f0] via-white to-[#e8e8f5]">
      ...
      {/* Sacred Mountains Section */}
      <section className="max-w-7xl mx-auto px-5 py-8">
        <Link href="/sacred-mountains" className="block group">
          <div className="bg-gradient-to-br from-slate-700 to-slate-900 rounded-3xl shadow-2xl hover:shadow-3xl transition-all duration-300 hover:-translate-y-1 overflow-hidden">
            <div className="p-8 md:p-12 text-white relative">
              {/* Decorative background pattern */}
              <div className="absolute inset-0 opacity-10">
                <div className="absolute top-10 right-10 w-32 h-32 bg-white rounded-full blur-2xl"></div>
              ...
              <div className="relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-white/90 text-lg mb-4 leading-relaxed">
                      Journey to sacred peaks where God met humanity. From Sinai to Tabor, experience the mountains of Scripture with multi-voice audio tours, stunning photography, and rich theological depth.
                    </p>

                    <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-sm">
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">🏔️</span>
                        <span>5 Mountains</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">🎧</span>
                        <span>Multi-Voice Audio</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">💡</span>
                        <span>40+ Fun Facts</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xl">📖</span>
                  ...
                  {/* CTA */}
                  <div className="text-center">
                    <div className="inline-block bg-white text-slate-800 hover:bg-slate-100 px-8 py-4 rounded-full font-bold text-xl shadow-xl group-hover:scale-105 transition-transform">
                      Explore Mountains →
                    </div>
                  </div>
                </div>
