          ...
          <div className={isPrayerMode ? 'h-full relative' : 'lg:col-span-2'}>
            <div className={isPrayerMode ? 'h-full relative' : 'bg-gray-800 rounded-xl overflow-hidden shadow-2xl'}>
              <div className={`relative ${isPrayerMode ? 'h-full' : 'w-full h-96 lg:h-[600px]'} bg-gray-700 overflow-hidden`}>
                ...
                {isPrayerMode && (currentStation.number >= 1 && currentStation.number <= 14) && (
                ...
                {/* Main Sharp Image - Desktop (landscape for all stations) */}
                <img
                  src={isPrayerMode && (currentStation.number >= 1 && currentStation.number <= 14)
                  ...
                  className={`w-full h-full relative z-5 hidden md:block ${
                    isPrayerMode && (currentStation.number >= 1 && currentStation.number <= 14) ? 'object-cover opacity-95' :
                ...
                {/* Main Sharp Image - Mobile (portrait for all stations) */}
                <img
                  src={isPrayerMode && (currentStation.number >= 1 && currentStation.number <= 14)
                  ...
                  className={`w-full h-full relative z-5 block md:hidden ${
                    isPrayerMode && (currentStation.number >= 1 && currentStation.number <= 14) ? 'object-contain opacity-95' :
                    'object-cover opacity-90'
                  }`}
                  onError={(e) => {
                    console.error('Failed to load station image');
